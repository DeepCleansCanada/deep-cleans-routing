...
function normalizeServiceKey(value) {
  ...
  if (
    service === "oven" ||
    service.includes("oven") ||
    service.includes("stove")
  ) {
    return "oven";
  }

  if (service === "carpet" || service.includes("carpet")) {
    return "carpet";
  }
  ...
  if (service === "gutter" || service.includes("gutter")) {
    return "gutter";
  }
  ...
  if (service === "lawn" || service.includes("lawn")) {
    return "lawn";
  }
